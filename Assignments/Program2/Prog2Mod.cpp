...
//
// Files:   Prog2Mod.cpp and P2Fn.dat
/////////////////////////////////////////////////////////////////////////////////
...
//This is where the function calls begin. 
  ...
  while (!infile.eof()) {
    ...
    outfile << ' ' << fixed << setprecision(2) << setw(8) << finv(value);
    ...
    outfile << ' ' << setw(10) << fixed << setprecision(2) << finvf(value);
    outfile << ' ' << setw(10) << fixed << setprecision(2) << ginvg(value);
    outfile << endl;
  }
}